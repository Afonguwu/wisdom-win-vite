...
<div class="container-xxl ">
    ...
    ,url('https://github.com/Afonguwu/wisdom-win-vite/blob/main/src/assets/img/serve-banner.jpg?raw=true');">服務項目</bannerTitle>
    <div class="content-div-p">
        <p class="text mb-6 fw-bold">我們的服務領域包括但不限於以下：
        </p>
        <div class="row">
            <serveCard v-bind:showContent="true"></serveCard>
        </div>
    </div>
</div>
</template>
